...
## Project Structure
    ...
    ├── testapiautosetting_127605  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127605`
...
2. Clone this repo and `cd testapiautosetting_127605`
